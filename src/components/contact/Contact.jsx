                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">kayro-valero</span>

                            <a href="https://www.linkedin.com/in/kayro-valero/ " target="_blank" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        </div>
                    </div>
                </div>

                <div className="contact_content">
                    <h3 className="contact_title">Describe me your project</h3>
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact_form">
                        ...
                        <div className="contact_form-div contact_form-area">
                            ...
                            <textarea name="project" cols="30" rows="10" className='contact_form-input' placeholder='Describe your project'></textarea>
                        </div>
